...
export default Utilities.memoizeObject({
    ...
    get UserPopout() {
        return BdApi.Components?.UserPopout
            ...
            ?? WebpackModules.getModule(m => m?.type?.toString?.().includes("Unexpected missing user"), {searchExports: true});
    },
    ...
    get SettingsNote() {return WebpackModules.getModule(m => m?.Types?.DESCRIPTION, {searchExports: true});},
